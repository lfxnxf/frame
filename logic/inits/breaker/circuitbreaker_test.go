...
//	c := clock.NewMock()
//	name := "TestTrippableBreakerState"
//	cb := NewBreaker(name)
//	cb.Clock = c
//
//	if !cb.Ready() {
...
//	c := clock.NewMock()
//	name := "TestTrippableBreakerManualBreak"
//	cb := NewBreaker(name)
//	cb.Clock = c
//	cb.Break()
//	c.Add(cb.nextBackOff + 1)
...
//	name := "TestConsecutiveBreaker"
//	cb := NewBreaker(name)
//	SettingConsecutiveError(name, true, 3)
//
//	if cb.Tripped() {
...
//}
//
//func NewThresholdBreaker(n int) *Breaker {
//	name := "123"
//	br := NewBreaker(name)
//	SettingThresholdError(name, true, n)
//	return br
//}
//
...
//		err = cb.Call(circuit, 0)
//		if err != nil {
//			t.Fatal("Expected cb to be successful", err)
//		}
//
//		if !success {
...
//}
//
//func NewRateBreaker(rate float64, min int) *Breaker {
//	cb := NewBreaker("rate")
//	SettingErrorPercent("rate", true, int(rate*100), min)
//	return cb
//}
//
