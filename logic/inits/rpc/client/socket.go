...
import (
	...
	"github.com/lfxnxf/frame/logic/inits/rpc/internal/ikiosocket"
	"github.com/lfxnxf/frame/logic/inits/rpc/internal/metadata"
...
func newIKSocket(logger *logging.Logger, conn net.Conn, req time.Duration) *ikRPCSocket {
