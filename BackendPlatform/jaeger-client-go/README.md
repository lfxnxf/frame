...
```yaml
- package: github.com/lfxnxf/frame/BackendPlatform/jaeger-client-go
  version: ^2.7.0
```
...
```shell
go get -u github.com/lfxnxf/frame/BackendPlatform/jaeger-client-go/
cd $GOPATH/src/github.com/lfxnxf/frame/BackendPlatform/jaeger-client-go/
...
See tracer initialization examples in [godoc](https://godoc.org/github.com/lfxnxf/frame/BackendPlatform/jaeger-client-go/config#pkg-examples)
...
[doc-img]: https://godoc.org/github.com/lfxnxf/frame/BackendPlatform/jaeger-client-go?status.svg
[doc]: https://godoc.org/github.com/lfxnxf/frame/BackendPlatform/jaeger-client-go
