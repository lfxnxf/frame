...
const (
	...
	JaegerClientVersion = "Go-2.11.4-inke"
	...
	// TracerDockerHostnameTagKey used to report docker host name of the process.
	TracerDockerHostnameTagKey = "docker.hostname"

	// TracerIPTagKey used to report ip of the process.
	TracerIPTagKey = "ip"

	// TracerDockerIPTagKey used to report ip of the process.
	TracerDockerIPTagKey = "docker.ip"
